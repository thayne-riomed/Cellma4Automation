...
test.describe('Excel Conversion', () => {
  test('Extract Patient Details', async ({}) => {
    const excelFilePath = process.env.EXCEL_FILE_PATH || './ExcelFiles/PatientDomain - Copy.xlsx';
  ...
  test.describe('New Patient', () => {
    test('Register New Patient', async ({ page }) => {
      ...
      for (const data of jsonData.addPatient) {
        ...
        //	try {
          //loginpage,homepage,environment moved above 
        //const loginpage = new LoginPage(page);
        //const homepage = new Homepage(page);
        //const environment = new Environment(page);
        const patientsearch = new PatientSearch(page);
    ...
    // await page.pause();
      ...
      // await page.pause();
        //await addgp.enterAppGpSearch(jsonData.addGP[index].egp_fullname);
        // Add GP To Patient
      ...
      // await page.getByTestId('Save').click()
        ...
        */
        ...
        await page.locator("xpath=//input[@aria-label='Family Name']").fill('rio');
        await page.locator("xpath=//button[@aria-label='Search']").click()
        await page.waitForTimeout(4000);
        await page.locator("xpath=//button[@aria-label='personAdd']").nth(0).click();
       ...
       // console.log("\n Address Details stored into the database: \n", results);
        ...
        page.on("console", async (msg) => {
          ...
          consoleLogs.push({
            ...
            await page.locator("xpath=//button[@aria-label='cellmaImageAvatar']").click();
            await page.waitForTimeout(2000)
        // await menu.clickOnMenubtn()
        //  await menu.clickOnLogout()
        // Listen for console events
